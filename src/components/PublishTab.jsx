...
const Dashboard = () => {
    ...
    const fetchBlogs = async () => {
      ...
      try {
        const response = await fetch(
          ...
          }/read-all/blogs?limit=${limit}&offset=${offset}`,
          {
            method: "GET",
          }
        );
  ...
  const handleUnpublishBlogs = async (id) => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_PUBLISH_URL}/unpublish/blog?id=${id}`,
        {
          method: "POST",
          headers: {
              ...
              <div className="p-4">
                ...
                <div className="mt-4 flex gap-4">
                  ...
                  <button
                    ...
                    onClick={() => handleUnpublishBlogs(blog.id)}
                  >
                    Unpublish
                  </button>
                </div>
